        ...
        var s,
          ...
          T = function (t) {
            ...
            for (e = 0; e < L.length; e++)
              if ((n = L[e] + i) in A.style) return { dom: n, css: C[e] + t };
          },
          O = (e.support = {
      ...
      i.define(
        ...
        (t.exports = function (t) {
          var e,
            ...
            m = !1;
          function w() {
            if (((n = l && i.env("design")), !!(e = s.find(f)).length))
              e.each(y),
          ...
          (o.ready = o.design = o.preview = w),
            ...
            (o.destroy = function () {
              if (!!(e = s.find(f)).length) e.each(b), g();
            });
          function b(e, n) {
            var i = t.data(n, f);
            if (!!i)
          ...
          function y(e, i) {
            var r = f.substr(1) + "-" + e,
              ...
              a = t.data(i, f);
            if (
              (!a && (a = t.data(i, f, { el: o, config: {} })),
              (a.current = null),
              (a.tabIdentifier = r + "-" + d),
              (a.paneIdentifier = r + "-data-w-pane"),
              ...
              var s = a.links.filter("." + h).attr(d);
              s && x(a, { tab: s, immediate: !0 });
            }
          }
          function x(e, n) {
            n = n || {};
            ...
            if (u !== e.current) {
              ...
              g.length && o.outro
                ? (g.each(v.outro),
                  a(g)
                    .add("opacity " + o.outro + "ms " + s, { fallback: c })
                    .start({ opacity: 0 })
                    .then(() => k(o, g, w)))
                : k(o, g, w);
            }
